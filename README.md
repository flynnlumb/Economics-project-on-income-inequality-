...
Next, To assess whether the results were sensitive to influential observations, Cook's distance was calculated for each observation. A robustness specification was then estimated after excluding observations with Cook's distance above the 4/n threshold.